...
function ScriptureOutput4(BibleText, scriptureReference){
    ...
    return (
        ...
        <h1>If you are <strong>Afraid</strong>, remember these words....</h1>
            ...
            <iframe width="80%" height="500"  src="https://www.youtube.com/embed/BVZxU2mHzVY" frameborder="0" allow="accelerometer; autoplay; clipboard-write; encrypted-media; gyroscope; picture-in-picture" allowfullscreen></iframe>
        </div>
        </div>
    ); 
}
