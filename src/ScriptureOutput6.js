...
function ScriptureOutput6(BibleText, scriptureReference){
    ...
    return (
        ...
        <h1>If you are <strong>Disgusted</strong>, remember these words....</h1>
            ...
            <iframe width="50%" height="500"  src="https://www.youtube.com/embed/dbYT7S066VI" frameborder="0" allow="accelerometer; autoplay; clipboard-write; encrypted-media; gyroscope; picture-in-picture" allowfullscreen></iframe>
        </div>
        </div>
    ); 
}
